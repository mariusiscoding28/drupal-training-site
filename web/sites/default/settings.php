 ...
 * @endcode
 */
$settings['hash_salt'] = 'IdbG6rohbVhS61w329DtoJuhQDc4QIaacuevREYrc_Svgj-1LS42wU76QedEp8i6EyLbY7HW9w';
...
$settings['config_sync_directory'] = 'sites/default/files/config_PXscuXMyZ57DcY8sx5Cv0Z9_pCyhVGu5o2YSac6yciSCyBbzVV4sj_z0G_uaQBgjNiO3Lk7PxA/sync';
// Disable CSS and JS aggregation to prevent missing files during development.
...
// Skip permissions hardening for local development.
$settings['skip_permissions_hardening'] = TRUE;

// Allow access to rebuild.php
$settings['rebuild_access'] = TRUE;

// Trust Gitpod or localhost domains.
$settings['trusted_host_patterns'] = [
  '^localhost$',
  '^127\.0\.0\.1$',
  '^.+\.gitpod\.io$',
